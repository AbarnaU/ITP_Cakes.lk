    ...
    <div class="cakes-flex-row">
      ...
      <!-- Main content --> 
              ...
              <table class="table table-striped table-bordered tcakes-user-table">
                <thead>
                  <tr>
                    ...
                    <td><a href="" class="cakes-sort-by">Customer Id<span class="caret"></span></a></td>
        ...
        try {
            ...
            String query = "select * from cake_order ";
...
%>
                  <tr>
                    ...
                    <td><a href="AdminDeleteCustomerOrderedCake?id=<%=resultSet.getString("cake_oid")%>" class="templatemo-edit-btn">Delete</a></td>       
        		</tr>
                  <%
            }
