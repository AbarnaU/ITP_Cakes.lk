                		...
                		<div class="billing_form_area">
                			<form class="billing_form row justify-content-center" action="CustomerOrderCake" method="post">
								...
								<div class="none">
									...
									<input type="text" class="form-control" id="cus_id" name="cus_id"  value="<%=resultSet.getString("uid") %>">
								</div>
								<div class="none">
								...
								<div class="form-group col-md-12">
									...
									<input type="date" class="form-control" id="odate" name="odate">
								</div>
								<div class="form-group col-md-12">
								    <label>Address</label>
							    ...
							    <div class="form-group text-center">
										<button type="submit" value="submit" class="btn pest_btn2">place order</button>
								</div>	
