      ...
      <!-- Main content --> 
        ...
        <div class="cakes-content-container">
          <div class="cakes-content-widget white-bg">
            <h2 class="margin-bottom-10 text-center">Edit Employee</h2>
...
%>
            ...
            <form action="AdminEditEmployee" name="add-employee" class="dream-destination-login-form" method="POST">   
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label>Employee ID</label>
                    <input type="text" class="form-control" id="eid" name="eid"  value="<%=resultSet.getString("eid") %>">                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label>Employee Name</label>
                    <input type="text" class="form-control" id="ename"name="ename" value="<%=resultSet.getString("ename") %>">                  
                </div> 
              </div>
                            <div class="row form-group">
			  <div class="col-lg-6 col-md-6 form-group">                  
                    <label>Employee Phone No</label>
                    <input type="text" class="form-control" id="epno" name="epno"  value="<%=resultSet.getString("epno") %>">                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label>Employee Address</label>
                    <input type="text" class="form-control" id="eaddress"name="eaddress" value="<%=resultSet.getString("eaddress") %>">                  
                </div> 
              </div>
              <div class="row form-group">
              	<div class="col-lg-6 col-md-6 form-group">                                  
                    <label>Employee Email </label>
                    <input type="text" class="form-control" id="eemail" name="eemail"  value="<%=resultSet.getString("eemail") %>">    
                </div>
              	 <div class="col-lg-6 col-md-6 form-group">                  
                    <label>Employee Job Title</label>
                    <input type="text" class="form-control" id="ejobtitle" name="ejobtitle"  value="<%=resultSet.getString("ejobtitle") %>">                  
                </div> 
              </div>
              <div class="row form-group">
              	<div class="col-lg-6 col-md-6 form-group">                                  
                    <label>Employee Date Start</label>
                    <input type="date" class="form-control" id="edstart" name="edstart"  value="<%=resultSet.getString("edstart") %>">    
                </div>
              	 <div class="col-lg-6 col-md-6 form-group">                  
                    <label>Employee Salary</label>
                    <input type="text" class="form-control" id="esalary" name="esalary"  value="<%=resultSet.getString("esalary") %>">                  
                </div> 
              </div>
               <div class="row form-group">
              	<div class="col-lg-6 col-md-6 form-group">                                  
                    <label>Employee NIC</label>
                    <input type="text" class="form-control" id="enic" name="enic"  value="<%=resultSet.getString("enic") %>">    
                </div> 
              </div>
