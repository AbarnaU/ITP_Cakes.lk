      ...
      <div class="cakes-sidebar">
        ...
        <nav class="cakes-left-nav">          
          <ul>
            ...
            <li><a href="AdminViewCustomerOrderedCake.jsp" class="active"><i class="fa fa-sliders fa-fw"></i>Cake Orders</a></li>
        ...
        <div class="cakes-content-container">
              ...
              <table class="table table-striped table-bordered tcakes-user-table">
                <thead>
                  <tr>
                    ...
                    <td><a href="" class="cakes-sort-by">Phone No <span class="caret"></span></a></td>
                    <td><a href="" class="cakes-sort-by">Cake Name <span class="caret"></span></a></td>
                    <td><a href="" class="cakes-sort-by">Delivery Date <span class="caret"></span></a></td>
               ...
               <%
                ...
                if (request.getAttribute("OrderList") != null) {
                    ...
                    while (itr.hasNext()) {
                        count++;
                        ArrayList OrderList = (ArrayList) itr.next();
           	 %>    
                  <tr>
                    
                  	<td><%=OrderList.get(0)%></td>
                    <td><%=OrderList.get(2)%></td>
                    <td><%=OrderList.get(3)%></td>
                    <td><%=OrderList.get(4)%></td>
                    <td><%=OrderList.get(5)%></td>    
                    <td><%=OrderList.get(6)%></td>  
                    <td><%=OrderList.get(7)%></td>
        		</tr>
          ...
          <%
            ...
            %>     
	          ...
	          <div class="text-center">
	         	 <a class="btn btn-primary " href="AdminViewCustomerOrderedCake.jsp">Back</a>   
          	</div>
        </div>
      </div>
	    </div>
