                ...
                <div class="row justify-content-center">
                	<div class="col-lg-6">
                		...
                		<div class="billing_form_area">
                			<form class="billing_form row justify-content-center" action="EditUserProfile" method="post">
                				 <%
								...
								<div class="form-group col-md-12">
									...
									<div class="form-group col-md-12">
								    <label>Phone</label>
									<input type="text" class="form-control" id="cnumber" name="cnumber" value="<%=resultSet.getString("phone")%>">
								</div>
							    ...
							    <div class="form-group text-center">
										<button type="submit" value="submit" class="btn pest_btn2">Update Profile</button>
								</div>	
