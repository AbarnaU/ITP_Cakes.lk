                ...
                <div class="row justify-content-center">
                	<div class="col-lg-6">
                		...
                		<div class="billing_form_area">
                			<form class="billing_form row justify-content-center" >
                				<%
									try {
								...
								<div class="form-group col-md-12">
									...
									<input type="text" class="form-control" id="userame" value="<%=resultSet.getString("username") %>">
								</div>
								<div class="form-group col-md-12">
								    <label>Email</label>
									<input type="email" class="form-control" id="email" value="<%=resultSet.getString("email") %>">
								</div>
								
								<div class="form-group col-md-12">
								    <label>Address</label>
									<input type="text" class="form-control" id="address"  value="<%=resultSet.getString("address") %>">
								</div>
								<div class="form-group col-md-12">
								    <label>Phone</label>
									<input type="text" class="form-control" id="phone"  value="<%=resultSet.getString("phone") %>">
								</div>
								<table>
								<tbody>
								<tr>
										<td><a class="pest_btn" href="EditUserProfile.jsp"> Edit Profile </a></td>
										
								
										<td><a href="UserDelete?id=<%=resultSet.getString("username")%>" class="pest_btn" > Deactivate Account </a></td>
								</tr>
								</tbody>
								</table>		
								</form>	
